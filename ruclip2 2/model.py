...
class CLIP(nn.Module):
    ...
    def forward(self, input_ids, pixel_values):
        ...
        res = self.new_layer(concatenated_features)
    ...
    @classmethod
    def from_pretrained(cls, folder, last_layer):
        ...
        checkpoint['new_layer.0.weight'] = last_layer[0].weight
        checkpoint['new_layer.0.bias'] = last_layer[0].bias
